...
class Trips{
    ...
    init(rider:Rider, fromStreetAddress:String, fromCity:String, fromState:String, fromZipCode:String, toStreetAddress:String, toCity:String, toState:String, toZipCode:String, pickUpTime: String, notes:String, postedTime: String, capacity: NSInteger)
    {
        self.driver = rider
